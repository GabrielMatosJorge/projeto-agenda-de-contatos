...
<div class="superinfo-bg">
    ...
    <section class="sobre" id="sobre">
        <div class="sobre-info">
            <h1>Sobre</h1>
            <p>A TimeFlow é uma empresa que ajuda pessoas e negócios a organizarem seus contatos de forma prática e segura. Com nossa plataforma, é possível cadastrar nomes, telefones, e-mails e outras informações importantes, tudo em um só lugar.
            </p>
            <p>
                 Nosso sistema é fácil de usar, funciona em qualquer dispositivo e permite encontrar rapidamente qualquer contato. Ideal para profissionais, equipes ou empresas que precisam manter suas conexões sempre atualizadas.
           </p>
        </div>
        <div class="sobre-img">
    ...
    <section class="produtos" id="produtos">
     ...
     <section class="qualidade" id="qualidade">
        ...
        <div class="qualidade-item">
            <h2>Sustentavel</h2>
            <p>representa uma abordagem que busca excelência sem comprometer o meio ambiente, os recursos naturais ou o bem-estar social. Ele vai além de atender bem o cliente: envolve responsabilidade, eficiência e visão de longo prazo.</p>
        </div>
     </section>
